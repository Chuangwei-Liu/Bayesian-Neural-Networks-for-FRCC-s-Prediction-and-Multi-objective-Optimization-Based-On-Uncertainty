...
if __name__ == "__main__":
    ...
    for train_col in train_cols:
        for seed in SEED_GRID:
            program1_success = run_python_script('MC-Dropout_training.py', f'{seed} Model Training', seed=seed, train_col=train_col)
            program2_success = run_python_script('MC-Dropout_validate.py', f'{seed} Model Validation', seed=seed, train_col=train_col)
